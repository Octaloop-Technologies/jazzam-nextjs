  ...
  return (
    ...
    >
      <div className="bg-white pt-[30px] p-5 rounded-3xl max-w-[458px] w-full text-center shadow-[0_4px_20px_0_rgba(0,0,0,0.08)]">
        ...
        <h2 className="text-[18px] font-[500] leading-none mb-1">{language?.deleteUser} {user?.userType === 'user' ? 'user': 'company'}!</h2>
        <p className="text-gray-200 mb-8 leading-none">
          {language?.deleteMessage} {user?.userType === 'user' ? 'user': 'company'} {language?.permanently}
        </p>
        <div className="flex justify-around space-x-5">
          ...
          <PrimaryButton
            ...
            className="w-full h-[50px] !gap-2.5 rounded-xl-2"
            title={isLoading ? language?.deletingUser : language?.deleteNow}
            titleClass="font-[500]"
