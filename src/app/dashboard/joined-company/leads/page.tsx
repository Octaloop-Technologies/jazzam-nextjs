...
import { getAllLeads, getCompany, getLeadStats, searchLeads } from "@/lib/utils/getJoinedCompanyLeads";
...
const joinedCompany = typeof window !== 'undefined' ? localStorage.getItem('joinedCompany') : null;
console.log("jddldlp;d", joinedCompany)
    if (joinedCompany) {
